    ...
    <>
        <section className='container main_section1_div mt-[50px] flex items-center justify-between'>
            <div className='shadow-xl bg-[#2d3663] max-w-[400px] p-[30px] rounded-[10px] pl-[30px] pb-[50px] section1_left'>
                ...
                <p className='text-[20px] font-normal max-w-[300px] text-white mt-4 ml-4 section1_left_title'>Беморлар кенг қамровли, тўлиқ ва ҳар тарафлама текширувдан ўтишлари ҳамда қуйидаги мутахассислардан малакали ёрдам олишлари мумкин:</p>
        ...
        <section className='container mt-[100px] flex justify-between quality'>
            <div className='quality_left'>
                ...
                <p className=' mt-2 font-bold text-[36px] max-w-[500px] text-blue-950 quality_text'>Кўп тармоқли клиникага хуш келибсиз</p>
                <p className='mt-3 max-w-[650px] text-[20px] text-blue-950 quality_text'>Биз Сиз билан ўзимизнинг кўп тармоқли ажойиб клиникамизда кўришиб турганимиздан мамнунмиз. Бу рисола саҳифалари орқали биз Сизни клиникамизнинг кенг қамровли хизматлари билан таништирамиз. Бу ерда, яъни тинч ва хавфсиз ҳудудда Сиз ўзингизни хотиржам ҳис қилишингиз, соғлигингизни тиклашингиз ва кучга тўлишингиз мумкин.</p>
            </div>
            <div className='mr-[50px] quality_right'>
                ...
                <ul className='mt-[40px] flex items-center justify-between gap-[40px] circle_list'>
                    <li className='hover:cursor-pointer hover:shadow-2xl hover:bg-blue-50 w-[200px] h-[200px] rounded-[50%] border-[5px] border-blue-950 flex flex-col items-center justify-center'>
                        <p className='font-bold text-[40px] text-blue-950 flex items-center'><motion.p>{rounded4}</motion.p>%</p>
                        <p className='text-[24px] text-blue-950 font-medium'>Sifat</p>
                    </li>
                    <li className='hover:cursor-pointer hover:shadow-2xl hover:bg-blue-50 w-[200px] h-[200px] rounded-[50%] border-[5px] border-blue-950 flex flex-col items-center justify-center'>
                        <p className='font-bold text-[40px] text-blue-950 flex items-center'><motion.p>{rounded5}</motion.p>%</p>
