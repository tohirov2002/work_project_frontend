...
import savol from '../../assets/images/savol.jpg'
        ...
        <>
            <section className='dark:bg-black container mt-[100px]'>
                <div className='flex flex-col items-center justify-center text-center'>
                    ...
                    <p className={`${mood? 'text-blue-950' : 'text-white'} text-[40px] `}>Hokimyat tomonidan qilingan saxovatli ishlar</p>
                </div>
                            ...
                            <SwiperSlide key={item.id}>
                                <div className={`${mood? '': 'bg-[#2D3663]'} flex items-center justify-around comments`}>
                                    <div className='ml-[60px] comment_title'>
                                        ...
                                        <p className='text-blue-600 text-[16px] text-start mt-5 comment_text'>fuqoro</p>
                                    </div>
            ...
            <section className='container mt-[150px] questin'>
                <div className='flex justify-around questin'>
                    <div>
                        <img className='max-w-[650px] h-[600px] rounded-2xl questin_img' src={savol} alt="operatsiya" />
                    </div>
