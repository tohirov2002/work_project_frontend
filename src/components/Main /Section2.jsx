  ...
  return (
    <>
        <section className='bg-[#2d3663] p-[40px] mt-[100px]'>
            <div className='container flex items-center justify-between'>
                <div>
                    ...
                    <p className='text-white font-bold text-[32px] mt-3'>Sinov uchun eng zamonaviy MRI skaner</p>
                    <p className='text-white text-[22px] max-w-[600px] mt-5'>Zamonaviy MRI skaneri tufayli bemorlarimiz tez va aniq tashxis qo‘yishadi, bu esa eng qisqa vaqt ichida davolashni boshlash imkonini beradi. Ishonchimiz komilki, ushbu yuqori texnologiyali uskunadan foydalanish sog‘liqni saqlash xizmatlarimiz samaradorligini oshirish va davolash natijalarini yaxshilashga yordam beradi.</p>
                ...
                <div className='mt-[20px]'>
                    <img className='max-w-[800px] h-[600px]' src={Mri} alt="mri" />
                </div>
            </div>
        </section>
        <section className='mt-[80px] container'> 
            ...
            <ul className='mt-[50px] flex items-center justify-between'>
