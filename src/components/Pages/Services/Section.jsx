   ...
   <>
    <section className='mt-[20px]'>
            <div className='services_image'>
                <h1 className='text-center text-white font-bold bg-[#00000050] h-[200px] text-[48px] pt-[60px]'>Хизматлар</h1>
            </div>
            <div className="container">
                <div className='mt-[100px]'>
                    <h1 className='text-white font-bold bg-[#2D3663] h-[200px] text-[40px] pr-[60px] flex justify-end pt-[100px]'>— БИЗНИНГ УСТУВОР ВАЗИФАМИЗ!</h1>
                </div> 
                <div className='mt-[100px]'>
                    ...
                    <div className='flex items-centerv justify-center mt-1'>
                        <h1 className='text-[#2D3663] text-center font-bold text-[40px] max-w-[1100px]'>Клиникамизда дунёнинг энг яхши шифокорлари сизни даволашади</h1>
                    </div>
                </div>
                <div className='flex justify-between mt-[30px]'>
                    ...
                    <div className='bg-[#EDF3F6] p-[60px] rounded-2xl ml-[50px]'>
                        ...
                        <div className='mt-[50px] flex items-center justify-between'>
                            <img className='max-w-[300px] h-[250px] rounded-2xl' src={mrt} alt="mrt" />
                            <img className='max-w-[300px] h-[250px] rounded-2xl' src={mskt} alt="mskt" />
                            <img className='max-w-[300px] h-[250px] rounded-2xl' src={aparat} alt="aparat" />
                        </div>
                        <div className='mt-[60px] flex'>
                            <button onClick={handleShow} className='flex items-center justify-center gap-3 text-white rounded-3xl w-[250px] pt-4 pb-4 mt-[30px] ml-4 bg-blue-950 hover:bg-slate-900'>Қабулга ёзилиш <FaArrowCircleRight className='mt-1 w-[18px] h-[18px]'/></button>
                            <button className='flex items-center justify-center gap-3 text-white rounded-3xl w-[250px] pt-4 pb-4 mt-[30px] ml-4 bg-blue-950 hover:bg-slate-900'>+998 (78) 669 02 03</button>
                        </div>
                        <button className='flex items-center justify-center gap-3 text-white rounded-3xl w-[250px] pt-4 pb-4 mt-[30px] ml-4 bg-blue-950 hover:bg-slate-900'>+998 (78) 669 05 04</button>
                    </div>
                </div>
