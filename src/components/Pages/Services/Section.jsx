            ...
            <div className='flex justify-between mt-[30px]'>
                ...
                <div className='bg-[#EDF3F6] p-[60px] rounded-2xl ml-[50px]'>
                    ...
                    <div className='mt-[60px] flex'>
                        <button className='flex items-center justify-center gap-3 text-white rounded-3xl w-[250px] pt-4 pb-4 mt-[30px] ml-4 bg-blue-950 hover:bg-slate-900'>Қабулга ёзилиш <FaArrowCircleRight className='mt-1 w-[18px] h-[18px]'/></button>
