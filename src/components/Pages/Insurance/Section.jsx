  ...
  return (
   <section className='mt-[20px]'>
        <div className='services_image'>
            <h1 className='text-center text-white font-bold bg-[#00000050] h-[200px] text-[48px] pt-[60px]'>Жарроҳлик</h1>
        </div>
        <div className="container mt-[100px]">
          <div className='flex items-center  justify-between'>
                  <div className=''>
                      <div className='bg-[#2D3663] p-[50px] rounded-3xl'>
                          <h1 className='font-bold text-white text-[40px]'>Бизнинг шиоримиз</h1>
                          <p className='text-white text-[18px] max-w-[600px] mt-5'>Авитсенна тиббиётининг кўп асрлик анъаналари замонавий нанотехнология билан уйғунлашган.
“Соғлом ҳаёт” тиббиёт маркази кўплаб касалликларни консерватив ва жарроҳлик усуллар билан даволаш учун энг янги ускуналар билан жиҳозланган замонавий, юқори малакали марказдир. Клиниканинг жарроҳлик ихтисослашуви Ўзбекистон Республикаси Соғлиқни сақлаш вазирлигининг литсензиясига мувофиқ амалга оширилади. (онкология, нейрохирургия, эндоваскуляр жарроҳлик, кардиология, гинекология, ортопедия ва травматология). Клиникада ўзининг лаборатория диагностика маркази мавжуд бўлиб, бунинг натижасида клиника беморлари энг қисқа вақт ичида барча керакли хизматларни бир жойда олишлари мумкин, улар бошқа тиббиёт муассасаларига боришлари шарт эмас.</p>
                  ...
                  <div className='bg-blue-50 p-[30px] pl-[50px] pr-[50px] rounded-2xl'>
                      <img className='max-w-[480px] h-[480px] rounded-[50%]' src={soglom_hayot} alt="soglom_hayot" />
                  </div>
          </div>
          <div className='mt-[100px]'>
            <h1 className='font-bold text-[#2D3663] text-[32px]'>Birinchi operatsion blok</h1>
          ...
          <div className='flex  justify-between mt-[150px]'>
                <div className='mt-[10px]'>
                    <h1 className='text-[#2D3663] text-[42px] font-bold'>Иккинчи оператсион блок</h1>
                ...
                <div className='mr-[50px] mt-8'>
                    <img className='max-w-[650px] h-[650px] rounded-[50%]' src={jarrohlik} alt="soglom_hayot" />
                </div>
          </div>
          <div className='flex  justify-around mt-[150px]'>
                <div className=''>
                  <img className='max-w-[650px] h-[650px] rounded-[50%]' src={labaratoriya} alt="labaratoriya" />
                </div>
                <div className='mt-[50px]'>
                    <h1 className='text-[#2D3663] text-[42px] font-bold'>Laparoskopik jarrohlik</h1>
          ...
          <div className='mt-[150px]'>
            <h1 className='font-bold text-[#2D3663] text-[40px]'>Uchinchi operatsiya bloki - travmatologiya bilan neyroxirurgiya:</h1>
